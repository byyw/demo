package com.byyw.demo.queue.data;

import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.log.Log;
import com.byyw.demo.queue.QueueConstant;
import com.byyw.demo.queue.exception.FileEOFException;
import com.byyw.demo.queue.exception.FileFormatException;
import com.byyw.demo.queue.util.MappedByteBufferUtil;
import lombok.Data;
...
public class DataEntity {
	...
	public void close() {
		try {
			...
			mappedByteBuffer.force();
			MappedByteBufferUtil.clean(fc, mappedByteBuffer);
