...
public class SystemCache {
    ...
    public static Cache<String, Cell> cache = Caffeine
            .newBuilder()
            .expireAfterAccess(1, TimeUnit.SECONDS) // 如果一天内对象没被访问，就清除
            .removalListener((String key, Cell graph, RemovalCause cause) -> {
